...
// node_modules/.pnpm/scroll-into-view@1.16.2/node_modules/scroll-into-view/scrollIntoView.js
var require_scrollIntoView = __commonJS({
  "node_modules/.pnpm/scroll-into-view@1.16.2/node_modules/scroll-into-view/scrollIntoView.js"(exports, module) {
    ...
    function animate(parent) {
      ...
      var location = getTargetScrollLocation(scrollSettings, parent), time = Date.now() - scrollSettings.startTime, timeValue = Math.min(1 / scrollSettings.time * time, 1);
    ...
    function transitionScrollTo(target, parent, settings, scrollAncestor, callback) {
      var idle = !parent._scrollSettings, lastSettings = parent._scrollSettings, now = Date.now(), cancelHandler, passiveOptions = { passive: true };
      if (lastSettings) {
...
export default require_scrollIntoView();
