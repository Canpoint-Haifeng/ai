<template>
  <div class="content-container">
    ...
    <!-- <collect-message
      dialogTitle="试题"
      collectPath="/paper/resources/collect?tabActiveName=QuesCollect"
      ref="collectMessage"
    >
    </collect-message> -->
    <!-- 纠错提示框 -->
        ...
        return this.apiGet(API.SCHOOL_QUES_GETQUESINFO, parms, set).then(
          (res) => {
            if (res.code === CTS.constant.SUCCESS_CODE) {
              ...
              // this.questionDetail.canCollect = false
              this.questionDetail.hideCollect = true
