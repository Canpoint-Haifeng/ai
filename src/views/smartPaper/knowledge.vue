<template>
  <div class="div_userScence content-container">
    <!-- 头部内容 -->
    <!-- <div class="flex div_header">
      <span class="span_text"> 选择场景:
      </span>
      <div class="itemWrap">
        <div class="div_item" v-for="item in scenceList" :key="item.id">
          <div
...
export default {
  ...
  methods: {
    ...
    //         if (res.data.length) {
    //           this.getTreeDataList(res.data[1].relationCategoryId)
    //         } else {
    //           this.treeDataList = []
