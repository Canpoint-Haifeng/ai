      ...
      tabs: [
        {
          ...
          id: 1,
          activeImg: null,
          imgUrl: import.meta.env.BASE_URL + 'assets/images/school/tab1.png',
        },
        {
          name: '知识点',
          id: 0,
          activeImg: null,
          imgUrl: import.meta.env.BASE_URL + 'assets/images/school/tab2.png',
        },
      ],
      isChapter: 1,
    ...
    executeDefaultChapter() {
      ...
      if (this.treeDataList && this.treeDataList[0]) {
        ...
        nextTick(() => {
          ...
          if (lemonTree.value) {
            lemonTree.value.setCurrentKey(data.chapterCode)
          }
        })
      } else {
