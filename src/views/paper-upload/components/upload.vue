...
export default {
  ...
  data() {
    return {
      ...
      uploadFileUrl: require('@/assets/images/upload_dia_bg.png'),
      fileListArr: [],
      fileList: [],
  ...
  created() {
    ...
    this.$nextTick(() => {
      setTimeout(() => {
        that.$refs.select_frame.ondrop = e => {
          e.preventDefault() // 阻止拖放后的浏览器默认行为
          that.uploadWrapClick(e)
        }
      }, 1000)
    })
  },
  methods: {
    ...
    handleAvatarSuccess(res, file, fileList) {
      if (res && res.code && res.code === 200) {
        ...
        this.isUpload = false
        this.uploadFileUrl = require('@/assets/images/upload_dia_success.png')
    ...
    continueUpload(val, e) {
      if (this.isSuccess === true) {
        ...
        this.uploadFileUrl = require('@/assets/images/upload_dia_bg.png')
