    ...
    >
      <div class="paper-main fl">
        ...
        <question-recycle-bin
          ...
          @get-paper-data="getPaperData"
        />
        <div
          class="paper-body-close-view"
          @click="goBackPreviousPage()"
        >
          <i class="iconfont iconguanbiyulan" /><span>关闭预览</span>
        </div>
      </div>
      <div class="paper-side fl">
        <div class="paper-side-body">
          <div
            v-if="paperSideBodyBottom"
          ...
          >
            ...
            />
            <paper-set :paper-data="paperData" />
            <paper-edit
              :paper-data="paperData"
              :questions-data="questionsData"
              @refresh-paper="onRefreshPaper"
...
import PaperSeal from './paper-seal/paper-seal'
import PaperHeader from './paper-header/paper-header'
import PaperBody from './paper-body/paper-body'
...
import PaperSet from './paper-set/paper-set'
import PaperEdit from './paper-edit/paper-edit'
...
export default {
  ...
  mixins: [paperPayMixin, questionItemMixin, windowScrollResetMixin],
  data() {
    return {
      loadView: false,
      paperData: {}, // 试卷信息
  ...
  methods: {
    ...
    // 顶欸回收站
    toRecycle() {
      this.$refs['question-recycle-bin'].toRecycle()
    },
  },
}
</script>
