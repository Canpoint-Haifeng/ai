  ...
  <div class="my-composition-segment">
    <div class="my-composition-title">
      <div class="my-composition-body">
        <span class="iconfont iconwodeziyuan1" />
        我的资源
      </div>
    </div>
    <div class="my-composition-content">
      ...
      <div
        v-show="activeTabs == '1'"
        class="my-composition-paper"
      >
        <div v-if="pageData.totalCount">
          <div class="title">
            <div class="title-text">
              共<span>{{ pageData.totalCount }}</span>套试卷
            </div>
            <div
              class="more"
              @click="openPaper"
            >
              更多试卷<i class="el-icon-arrow-right" />
            </div>
          </div>
          <div
            v-if="pageData.list && pageData.list.length"
            class="my-paper"
          >
            <PaperHomeList :list="pageData.list" />
          </div>
        </div>
        <div
          v-else
          class="no-composition-resource"
        >
      ...
      <div
        v-show="activeTabs == '2'"
        class="my-composition-ques"
      >
        <div v-if="questionTotalCount && questionList.length">
          <div class="title">
            <div class="title-text">
              共<span>{{ questionTotalCount }}</span>道题目
            </div>
            <div
              class="more"
              @click="openQuestion"
            >
              更多试题<i class="el-icon-arrow-right" />
            </div>
          </div>
          <div class="my-composition-ques-body">
            ...
            >
              ...
              <div
                v-if="questionItem"
                class="question-footer clearfix"
              >
                <span>题型：<em class="">{{
                ...
                <span
                  class="r"
                  @click="openDetailQues(questionItem)"
                >
      ...
      <div
        v-show="activeTabs == '3'"
        class="my-composition-book"
      >
        <div v-if="booksDataTotalCount">
          <div class="title">
            <div class="title-text">
              共<span>{{ booksDataTotalCount }}</span>本图书
            </div>
          </div>
          <div v-if="booksData && booksData.length">
            <MyCompositionBooks :books="booksData" />
          </div>
        </div>
        <div
          v-else
