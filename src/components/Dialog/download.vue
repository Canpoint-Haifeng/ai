...
export default {
  ...
  setup(props, { emit }) {
    ...
    const confiem = () => {
      ...
      newPost({ urlPath }, params).then(res => {
        if (res.code == 200) {
        } else {
