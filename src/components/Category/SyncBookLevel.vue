...
export default defineComponent({
    ...
    return {
        getGradesList() {
            ...
            this.gradesList = [{ code: '1,2,3,4', name: '全部' })

    return { { code: '1,2', name: '网络级' })

    return { { code: 3, name: '精品级' })

    return { { code: 4, name: '出版级' }]
            return
            this.apiGet({ urlPath: '/paper-builder/config/getQuestionLevel' })
