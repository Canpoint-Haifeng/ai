        ...
        >
          ...
          >
            ...
            <div class="pay-qpcoin">
              <i class="iconfont iconcoin" />账户全品币：
          ...
          >
            ...
            <div class="coin-item coin-my">
              <i class="iconfont iconcoin" />本次下载将扣减全品币：
          ...
          >
            ...
            <p class="text1 color-3 font-16 font-b">
              支付成功！
            </p>
            <p class="text2 color-9 font-12">
              点击"确认下载"按钮开始下载吧
            </p>
          </div>
        </div>
