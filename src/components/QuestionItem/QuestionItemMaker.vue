    ...
    >
      ...
      >
        ...
        <div class="question-operation-right">
          ...
          >
            <span class="operate-btn check-btn">报错</span>
          </div>
          <div
            v-if="questionItem.questionInfo.editType1"
            class="operate-item"
            @click="checkEditQuestion"
          >
            <!-- 1改编，2编辑，0不改编也不编辑 -->
            <span class="operate-btn check-btn">{{
              questionItem.questionInfo.editType == 1 ? '改编' : '编辑'
            }}</span>
          </div>
          <div
            class="operate-item"
            @click.stop="checkChangeQuestion"
          >
      ...
      <i
        class="delete-item el-icon-error"
