      ...
      <div class="question-bottom">
        ...
        <div class="question-operate">
          ...
          <!-- <span v-if="isShowCancelShare" class="operate-btn check-btn" @click.stop="clickCancelShare">
            <i class="icon iconshiliangzhinengduixiang2-01"></i>取消分享
          </span> -->
          <span
            v-if="showView === 0"
            class="operate-btn check-btn"
          ...
          <!-- <span class="operate-btn report-btn" v-if="showDelete" @click.stop="showDeleteDialog">
            <i class="icon el-icon-delete"></i>删除
          </span> -->
          <span
            v-if="
          ...
          <!-- <span @click="collectQuestion" class="operate-btn collected-btn">
              <i class="icon " :class="{'iconshoucang':!(questionItem.isCollected===1),'iconquxiaoshoucang':(questionItem.isCollected===1)}"></i>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { {color: '#999', name: '初始'})

    return { {color: '#f4bd41', name: '基础'})

    return { {color: '#ef8944', name: '网络'})

    return { {color: '#f59b23', name: '精品'})

    return { {color: '#ed7764', name: '出版'}]
      levels: [{})
